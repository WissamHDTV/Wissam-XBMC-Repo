...
class DIXIESource(Source):
    ...
    def GetDixieUrl(self):
        ...
        if dixieUrl == 'DATHO DIGITAL - DC LISTINGS':
            dixieUrl = 'https://github.com/WissamHDTV/Wissam-XBMC-Repo/raw/master/tvgdatafiles/spaingmt.xml'
            return dixieUrl
    ...
    def getCategories(self):
        ...
        url = 'https://raw.github.com/WissamHDTV/Wissam-XBMC-Repo/master/tvgdatafiles/cats.xml'
