...
if __name__ == '__main__':
    if deleteDB():
        d = xbmcgui.Dialog()
        d.ok('WissamLiveTV', 'Database successfully deleted.', 'It will be re-created next time', 'you start the guide')    
    else:
        d = xbmcgui.Dialog()
        d.ok('WissamLiveTV', 'Failed to delete database.', 'Database may be locked,', 'please restart XBMC and try again')
