...
Url = 'https://raw.github.com/WissamHDTV/Wissam-XBMC-Repo/master/logos.zip'
LocalName = 'logos.zip'
LocalFile = xbmc.translatePath(os.path.join(Path, LocalName))
dialog.update(33)
try: urllib.urlretrieve(Url,LocalFile)
except:xbmc.executebuiltin("XBMC.Notification(TV Guide Wissam,Logo download failed,3000)")
dialog.update(66)
if os.path.isfile(LocalFile):
    ...
    dialog.close()
    ok = xbmcgui.Dialog()
    ok.ok('TV Guide Wissam', 'Logo Pack Download Complete')
